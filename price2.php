...
<html>
<head>
<title>Camera Catalog - Intermediate Cameras</title>
<style type="text/css">
	...
	<body>
		...
		<h2 class="intro center">Intermediate Cameras</h2>
		...
		<?php
			...
			$result = mysqli_query($con,"SELECT * FROM camera WHERE cm_price BETWEEN '801' AND '1900' ORDER BY cm_price") or die (mysql_error());
		...
		<div class="youtube">
			<iframe width="560" height="315" src="https://www.youtube.com/embed/dHNKEov1OZM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
