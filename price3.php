...
<html>
<head>
<title>Camera Catalog - Professional Cameras</title>
<style type="text/css">
	...
	<body>
		...
		<h2 class="intro center">Professional Cameras</h2>
		...
		<?php
			...
			// $result = mysqli_query($con,"SELECT * FROM camera") or die (mysql_error());
			...
			$result = mysqli_query($con,"SELECT * FROM camera WHERE cm_price BETWEEN '1901' AND '100000' ORDER BY cm_price") or die (mysql_error());
		...
		<div class="youtube">
			<iframe width="560" height="315" src="https://www.youtube.com/embed/31gPArhv54Q" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
