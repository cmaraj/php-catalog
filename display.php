...
<style type="text/css">
	...
	<body>
		...
		<h2 class="intro center">Camera Catalog</h2>

		<p class="intro">For the catalog project I am planning to use different cameras as my base item. I have always been interested and fascinated by small differences and upgrades that newer or older models featured. This project will be an excellent platform to really dive into the specifics of different cameras. I have only used a handful of different cameras so I think it will be fun and interesting to get to explore the cameras that I might never get to use or perhaps some that I might invest in, in the near future. Either way, this project will really open up the world of cameras both for myself and whoever views it. </p>
		
		<p class="intro">I think for a lot of people buying a camera can be an intimiating process. There are numerous brands, styles, and complicated components that make up differences within cameras. Hopefully this site is a way to compare a lare group of cameras that range from beginner or entry level cameras, all the way to the high-end professional cameras.</p>
